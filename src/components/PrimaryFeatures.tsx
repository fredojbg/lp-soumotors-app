...
const features = [
  ...
  },
  {
    title: 'Agendamentos',
    description:
      'Facilite a marcação de serviços e otimize o tempo da sua equipe com nosso sistema de agendamento online. Notificações em tempo real para manter seus clientes informados.',
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl">
            Tudo o que você precisa para administrar sua oficina.
          </h2>
          <p className="mt-6 text-lg tracking-tight text-blue-100">
            Transforme a maneira como você gerencia seu negócio automotivo com
